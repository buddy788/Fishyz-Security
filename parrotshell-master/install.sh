...
echo -e " #       #  ####  #    #   #   ###### 
echo ""
echo -e "\e[1;91m [+] YouTube: \e[1;92mBloopy A"
echo -e "\e[1;91m [+] Github: \e[1;92mBuddy788\e[1;97m"
echo ""
read -p " Does you want to install Fishyz Security in Termux?(Yes/No) : " input
